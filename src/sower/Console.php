...
use sower\console\command\Build;
use sower\console\command\Clear;
use sower\console\command\Help;
use sower\console\command\Help as HelpCommand;
use sower\console\command\Lists;
use sower\console\command\make\Command as MakeCommand;
use sower\console\command\make\Controller;
use sower\console\command\make\Event;
use sower\console\command\make\Listener;
use sower\console\command\make\Middleware;
use sower\console\command\make\Model;
use sower\console\command\make\Service;
use sower\console\command\make\Subscribe;
use sower\console\command\make\Validate;
use sower\console\command\optimize\Config;
use sower\console\command\optimize\Route;
use sower\console\command\optimize\Schema;
use sower\console\command\RouteBuild;
use sower\console\command\RouteList;
use sower\console\command\RunServer;
use sower\console\command\ServiceDiscover;
use sower\console\command\VendorPublish;
use sower\console\command\Version;
use sower\console\Input;
use sower\console\input\Argument as InputArgument;
use sower\console\input\Definition as InputDefinition;
use sower\console\input\Option as InputOption;
use sower\console\Output;
use sower\console\output\driver\Buffer;
use sower\worker\command\Worker;
use sower\worker\command\Server;
use sower\worker\command\GatewayWorker;
use sower\swoole\command\Server as Swoft;
/**
 * 控制台应用管理类
 */
class Console
{
    ...
    protected $defaultCommands = [
        ...
        'optimize:routes'   => Route::class,
        'run'              => RunServer::class,
        'version'          => Version::class,
        'routes:list'       => RouteList::class,
        'routes:build'      => RouteBuild::class,
        'service:discover' => ServiceDiscover::class,
        'vendor:publish'   => VendorPublish::class,
        'worker'           => Worker::class,  
		'workerServer'     => Server::class,
		'GatewayWorker'    => GatewayWorker::class,	
	    'Swoft'            => Swoft::class,		
    ];
