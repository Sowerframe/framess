...
class Response
{
    ...
    {
        $class = false !== strpos($type, '\\') ? $type : '\\sower\\service\\respond\\' . ucfirst(strtolower($type));
    ...
    public function content($content)
    {
        if (null !== $content && !is_string($content) && !is_numeric($content) && !is_callable([
            ...
            throw new \InvalidArgumentException(sprintf('Array not defined： %s', gettype($content)));
        }
