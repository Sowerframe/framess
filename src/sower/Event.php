...
class Event
{
     ...
     */
    protected $bind = [
        'AppInit'  =>  service\event\AppInit::class,
        'HttpRun'  =>  service\event\HttpRun::class,
        'HttpEnd'  =>  service\event\HttpEnd::class,
        'LogLevel' =>  service\event\LogLevel::class,
        'LogWrite' =>  service\event\LogWrite::class,
    ];
