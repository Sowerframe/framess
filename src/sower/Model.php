...
use driver\model\concern\Attribute;
use driver\model\concern\RelationShip;
use driver\model\concern\ModelEvent;
use driver\model\concern\TimeStamp;
use driver\model\concern\Conversion;
    /**
     * 数据是否存在
     * @var bool
     */
    ...
    {
        if ($this->exists) {
            $this->data   = $this->db()->fetchArray()->first($this->getKey());
            $this->origin = $this->data;
